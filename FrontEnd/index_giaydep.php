...
<head>
    ...
    <link rel="stylesheet" href="./css/index_giaydep.css">
    <title>Shop DiNo-Giày Dép</title>
...
<body>
    ...
    <header>
          ...
          <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start" >
              <a href="/" class="d-flex align-items-center my-2 my-lg-0 me-lg-auto text-white text-decoration-none">
                <img src="./image/logo2.png" width="150"  height="32" alt=""></a>
        ...
        <div id="menu">
          ...
          <ul>
          <img src="./image/home.jpg" width="30" height="30" style=" margin-right: 25px;"alt="">
    ...
    <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="./image/banner4.png" alt="" width="100%" height="100%">
    
            
          </div>
          <div class="carousel-item">
            <img src="./image/banner5.png" alt="" width="100%" height="100%">
            
          </div>
          <div class="carousel-item">
            <img src="./image/banner3.jpg" alt="" width="100%" height="100%">    
    ...
    <div class="container marketing">
       <div class="row">
        <div class="col-lg-4">
          <img src="./image/quanao.jpg" class="rounded-circle" width="140" height="140" alt="giaydep" >
  
          <h2>Quần Áo</h2>
          <p>Chất lượng là nền tảng của thương hiệu, chất lượng là hiện thân của uy tín, và chất lượng là sự đảm bảo cho thị trường.
          </p>
          <p><a class="btn btn-secondary" href="#">View details &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          <img src="./image/giaydep.jpg" class="rounded-circle" width="140" height="140" alt="giaydep" >  
          <h2>Giày Dép</h2>
          <p> Phẩm chất ở trong lòng, thương hiệu nổi tiếng ở trong tay, trách nhiệm ở trên vai, và sự chính trực nằm trong lời nói và việc làm.
          </p>
          <p><a class="btn btn-secondary" href="#">View details &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          <img src="./image/kinhmat.jpg" class="rounded-circle" width="140" height="140" alt="giaydep" >  
          <h2>Kính Mắt</h2>
          <p>Với quản lý hạng nhất, hãy nuôi dưỡng đội ngũ hạng nhất, phấn đấu vì chất lượng hạng nhất và tạo ra lợi ích hạng nhất.
          </p>
          <p><a class="btn btn-secondary" href="#">View details &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
      </div><!-- /.row -->
    ...
    <section class="py-5 text-center container" style="height: 250px;">
        <div class="row py-lg-5">
          <div class="col-lg-6 col-md-8 mx-auto">
            <h2 class="" style="font-size: 40px;">Danh Mục Giày Dép </h1>
              <p>
         ...
         ?>
            <div class="col" >
              <div class="card shadow-sm">
               <a href="../FrontEnd/product.php"> <img src="../BackEnd/uploads/<?php echo $result['image'] ?>" width="100%" height="380px"  ></a>
                <div class="icon-display-combo" >
                 <img src="./image/iconsale.png" width="45px" alt="">
                </div>
                <div class="addCart">
                ...
                <div class="card-body">
                  <p class="card-text" style="font-weight: 500;"><?php echo $result['productName'] ?></p>
