...
<body>
    ...
    <header>
          ...
          <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start" >
              <a href="/" class="d-flex align-items-center my-2 my-lg-0 me-lg-auto text-white text-decoration-none">
                <img src="../FrontEnd/image/logo2.png" width="150"  height="32" alt=""></a>
        ...
        <div id="menu">
          ...
          <ul>
          <img src="../FrontEnd/image/home.jpg" width="30" height="30" style=" margin-right: 25px;"alt="">
    ...
    <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../FrontEnd/image/banner1.png" alt="" width="100%" height="100%">
    
            
          </div>
          <div class="carousel-item">
            <img src="../FrontEnd/image/banner2.jpg" alt="" width="100%" height="100%">
            
          </div>
          <div class="carousel-item">
            <img src="../FrontEnd/image/banner3.jpg" alt="" width="100%" height="100%">    
            ...
            <div class="product-content">
                <div class="product-content-left  ">
                    <div class="product-content-left-big-img">
                        <img src="../FrontEnd/image/sp1.jpg" alt="">
                    </div>
                    <div class="product-content-left-small-img">
                        <img src="../FrontEnd/image/sp2.jpg" alt="">
                        <img src="../FrontEnd/image/sp1.jpg" alt="">
                        <img src="../FrontEnd/image/sp1.jpg" alt="">
                        <img src="../FrontEnd/image/sp1.jpg" alt="">
                    </div>
                ...
                <div class="product-content-right">
                  <div class="product-content-right-product-name">
                    ...
                    <p style="color: red;">MSP: 57E2969</p>
                  </div>
                  ...
                  <div class="product-content-right-product-color">
                    ...
                    <div class="product-content-right-product-color-img">
                        <img src="../FrontEnd/image/spcolor.png" alt="">
                    </div>
                 </div>
               ...
               <div class="product-content-right-product-button">
                  <button><i class="fas fa-shopping-cart"></i> <p style="padding-top: 14px;">MUA HÀNG</p></button>
                  <button><p style="padding-top: 5px;">TÌM TẠI CỬA HÀNG</p></button>
              </div>
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-6 g-4">
          <div class="col" style="margin-top:50px">
            <div class="card shadow-sm">
              <img src="../FrontEnd/image/sp1.jpg" width="100%" height="490px"  alt="CHÂN VÁY XẾP LY" title="CHÂN VÁY XẾP LY">
              <div class="icon-display-combo" >
                <img src="../FrontEnd/image/iconsale.png" width="45px" alt="">
              </div>
              <div class="addCart">
              ...
              <div class="card-body">
                <p class="card-text" style="font-weight: 500;">CHÂN VÁY XẾP LY VL123</p>
          ...
          <div class="col" style="margin-top:50px">
            <div class="card shadow-sm">
              <img src="../FrontEnd/image/sp2.jpg" width="100%" height="490px"  alt="QUẦN JEANS SKINNY" title="QUẦN JEANS SKINNY">
              <div class="icon-display-combo" >
                <img src="../FrontEnd/image/iconsale.png" width="45px" alt="">
              </div>
              <div class="addCart">
              ...
              <div class="card-body">
                <p class="card-text" style="font-weight: 500;">QUẦN JEANS SKINNY QJB8103</p>
                <div class="d-flex justify-content-between align-items-center" style="margin-top: -6px;">
                  <p>
          ...
          <div class="col" style="margin-top:50px">
            <div class="card shadow-sm">
              <img src="../FrontEnd/image/sp3.jpg" width="100%" height="490px"  alt="">
              <div class="icon-display-combo" >
                <img src="../FrontEnd/image/iconsale.png" width="45px" alt="">
              </div>
              <div class="addCart">
              ...
              <div class="card-body">
                <p class="card-text" style="font-weight: 500;">ÁO KIỂU THẮT NƠ CỔ AB8100</p>
                <div class="d-flex justify-content-between align-items-center" style="margin-top: -6px;">
                  <p>
          ...
          <div class="col" style="margin-top:50px">
            <div class="card shadow-sm">
              <img src="../FrontEnd/image/sp4.jpg" width="100%" height="490px"  alt="">
              <div class="icon-display-combo" >
                <img src="../FrontEnd/image/iconsale1.png" width="45px" alt="">
              </div>
              <div class="addCart">
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-cart-plus-fill" viewBox="0 0 16 16">
                  <path d="M.5 1a.5.5 0 0 0 0 1h1.11l.401 1.607 1.498 7.985A.5.5 0 0 0 4 12h1a2 2 0 1 0 0 4 2 2 0 0 0 0-4h7a2 2 0 1 0 0 4 2 2 0 0 0 0-4h1a.5.5 0 0 0 .491-.408l1.5-8A.5.5 0 0 0 14.5 3H2.89l-.405-1.621A.5.5 0 0 0 2 1H.5zM6 14a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm7 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0zM9 5.5V7h1.5a.5.5 0 0 1 0 1H9v1.5a.5.5 0 0 1-1 0V8H6.5a.5.5 0 0 1 0-1H8V5.5a.5.5 0 0 1 1 0z"/>
              ...
              <div class="card-body">
                <p class="card-text" style="font-weight: 500;">ĐẦM DÂY ĐẮP CHÉO TÀ DB8101</p>
                <div class="d-flex justify-content-between align-items-center" style="margin-top: -6px;">
                  <p>
        ...
        <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
          <div class="col" style="height: 352px;">
            <div class="card card-cover h-100 overflow-hidden text-white bg-dark rounded-5 shadow-lg" >
              <a href=""><img src="../image/tin2.png" alt=""></a>
            </div>
          </div>
    
          <div class="col"  style="height: 352px;">
            <div class="card card-cover h-100 overflow-hidden text-white bg-dark rounded-5 shadow-lg" >
              <a href=""><img src="../image/tin1.1.png" alt=""></a>
            </div>
          </div>
    
          <div class="col"  style="height: 352px;">
            <div class="card card-cover h-100 overflow-hidden text-white bg-dark rounded-5 shadow-lg" >
              <a href=""><img src="../image/tin3.png" alt=""></a>
            </div>
          </div>
        </div>
      </div>
...
<script src="../FrontEnd/js/style.js">
