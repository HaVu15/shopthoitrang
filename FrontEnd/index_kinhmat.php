...
<head>
    ...
    <link rel="stylesheet" href="./css/index_kinhmat.css">
    <title>Shop DiNo-Kính Mắt</title>
    ...
    <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="./image/banner2.png" alt="" width="100%" height="100%">
    ...
    <section class="py-5 text-center container" style="height: 250px;">
        <div class="row py-lg-5">
          <div class="col-lg-6 col-md-8 mx-auto">
            <h2 class="" style="font-size: 40px;">Danh Mục Kính Mắt </h1>
              <p>
         ...
         ?>
            <div class="col" >
              <div class="card shadow-sm">
               <a href="../FrontEnd/product.php"> <img src="../BackEnd/uploads/<?php echo $result['image'] ?>" width="100%" height="320px"  ></a>
